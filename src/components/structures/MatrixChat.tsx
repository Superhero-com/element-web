...
import { showStartChatInviteDialog, showRoomInviteDialog } from "matrix-react-sdk/src/RoomInvite";
...
import NewRecoveryMethodDialog from "matrix-react-sdk/src/async-components/views/dialogs/security/NewRecoveryMethodDialog";
import RecoveryMethodRemovedDialog from "matrix-react-sdk/src/async-components/views/dialogs/security/RecoveryMethodRemovedDialog";
...
export default class MatrixChat extends React.PureComponent<IProps, IState> {
    ...
    public render(): React.ReactNode {
        ...
        if (this.state.view === Views.LOADING) {
            ...
            view = (
                <Registration
                    inviteCode={this.props.startingFragmentQueryParams?.invite?.toString()}
